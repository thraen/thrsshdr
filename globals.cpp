...
// snd_pcm_t		*handle		= (snd_pcm_t*) malloc(sizeof( snd_pcm_t));
// snd_pcm_t		*handle		= (snd_pcm_t*) malloc(10000);

double* x[2] = { (double *) malloc(sizeof(double)*_buflen),
				 (double *) malloc(sizeof(double)*_buflen)};
	// 	x[0] = (double *) malloc(sizeof(double)*_buflen);
	// 	x[1] = (double *) malloc(sizeof(double)*_buflen);
	// memset(x[0], 0, sizeof (double) * _buflen); 
	// memset(x[1], 0, sizeof (double) * _buflen);
