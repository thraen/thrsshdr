...
class Things{
	...
	public:
		...
		// stichpunkt pure virtual: 											durch = 0 definiert
		// merke: 
		// virtual 		-> kann ueberschrieben werden, muss aber (in der basisklasse) definiert sein
		// pure virtual -> muss und kann nur in erbender klasse definiert sein.
